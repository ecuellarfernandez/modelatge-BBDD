...
-- -----------------------------------------------------
-- Table `6_optics`.`order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `6_optics`.`order` (
...
-- -----------------------------------------------------
-- Table `6_optics`.`referral`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `6_optics`.`referral` (
  `new_client` INT NOT NULL,
  `referral_client` INT NULL,
  PRIMARY KEY (`new_client`, `referral_client`),
  INDEX `fk_referral_client2_idx` (`referral_client` ASC),
  CONSTRAINT `fk_referral_client1`
    FOREIGN KEY (`new_client`)
    REFERENCES `6_optics`.`client` (`id_client`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_referral_client2`
    FOREIGN KEY (`referral_client`)
    REFERENCES `6_optics`.`client` (`id_client`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
